...
Route::get('crypto', [HomePageController::class, 'crypto'])->name('crypto');
Route::get('forex', [HomePageController::class, 'forex'])->name('forex');
Route::get('gold', [HomePageController::class, 'gold'])->name('gold');
Route::get('statistic', [HomePageController::class, 'statistic'])->name('statistic');
