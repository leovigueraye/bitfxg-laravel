					...
					<div class="col text-center card p-4 bg-<?php echo e($bg); ?>">
					        ...
					        <nav>
								<div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
								  ...
								  <h4 class="pt-3 nav-item nav-link active " id="nav-home-tab" data-bs-toggle="tab" href="#1" role="tab" aria-controls="nav-home" aria-selected="true"> Deposits</h4>
		
								  <h4 class="pt-3 nav-item nav-link" id="nav-profile-tab" data-bs-toggle="tab" href="#2" role="tab" aria-controls="nav-profile" aria-selected="false">Withdrawals</h4>
		
								  <h4 class="pt-3 nav-item nav-link" id="nav-contact-tab" data-bs-toggle="tab" href="#3" role="tab" aria-controls="nav-contact" aria-selected="false">Others</h4>
							    </div>
							</nav>
        							...
        							<table id="UserTable" class="UserTable table table-hover text-<?php echo e($text); ?>"> 
        									...
        									<tbody> 
        										...
        										<tr> 
													...
													<span class="badge bg-success"><?php echo e($withdrawal->status); ?></span>
													<?php else: ?>
														<span class="badge bg-danger"><?php echo e($withdrawal->status); ?></span>
													<?php endif; ?>
													</td> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects-work\bitfxg-laravel\resources\views/user/transactions.blade.php ENDPATH**/ ?>