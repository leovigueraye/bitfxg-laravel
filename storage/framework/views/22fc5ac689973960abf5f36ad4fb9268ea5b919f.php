            ...
            <div class="page-inner">
                ...
                <div class="p-3 shadow-lg row ">
                    <div class="mb-3 col-lg-12">
                        <a href="<?php echo e(url('dashboard/buy-plan')); ?>" class="btn btn-lg btn-<?php echo e($text); ?> nav-pills"> <i class="fa fa-plus"></i> Add plan</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Production\24fxtrade\Account\resources\views/user/myplans.blade.php ENDPATH**/ ?>