		...
		<div class="main-panel">
			<div class="content bg-<?php echo e($bg); ?>">
				<div class="page-inner">
					<div class="mt-2 mb-4">
						<h1 class="title1 text-<?php echo e($text); ?>">Update Investment Plan</h1>
					</div>
                                ...
                                <form role="form" method="post" action="<?php echo e(route('updateplan')); ?>">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input  class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" value="<?php echo e($plan->name); ?>" placeholder="Enter Plan name" type="text" name="name" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <h5 class="text-<?php echo e($text); ?>">Plan price(<?php echo e($settings->currency); ?>)</h5> 
                                            <input class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" value="<?php echo e($plan->price); ?>" placeholder="Enter Plan price" type="text" name="price" required>   
                                            <small class="text-<?php echo e($text); ?>">This is the maximum amount a user can pay to invest in this plan</small>
                                       </div>	
                                       <div class="form-group col-md-6">
                                            <h5 class="text-<?php echo e($text); ?>">Plan Minimum Price (<?php echo e($settings->currency); ?>)</h5> 			 
                                             <input placeholder="Enter Plan minimum price" value="<?php echo e($plan->min_price); ?>" class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" type="text" name="min_price" required>  
                                             <small class="text-<?php echo e($text); ?>">This is the minimum amount a user can pay to invest in this plan</small> 
                                       </div>
                                       <div class="form-group col-md-6">
                                             <h5 class="text-<?php echo e($text); ?>">Plan Maximum Price (<?php echo e($settings->currency); ?>)</h5> 			 
                                             <input class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" value="<?php echo e($plan->max_price); ?>" placeholder="Enter Plan maximum price" type="text" name="max_price" required> 
                                            <small class="text-<?php echo e($text); ?>">Same as plan price</small> 
                                       </div>
                                       <div class="form-group col-md-6">
                                            <h5 class="text-<?php echo e($text); ?>">Minimum return (%)</h5> 
                                           <input class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" value="<?php echo e($plan->minr); ?>" placeholder="Enter minimum return" type="text" name="minr" required>   
                                           <small class="text-<?php echo e($text); ?>">This is the minimum return (ROI) for this plan</small>
                                       </div>
                                       <div class="form-group col-md-6">
                                            <h5 class="text-<?php echo e($text); ?>">Maximum return (%)</h5> 
                                           <input class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" value="<?php echo e($plan->maxr); ?>" placeholder="Enter maximum return" type="text" name="maxr" required>  
                                           <small class="text-<?php echo e($text); ?>">This is the Maximum return (ROI) for this plan</small> 
                                       </div>
                                       <div class="form-group col-md-6">
                                            <h5 class="text-<?php echo e($text); ?>">Gift Bonus (<?php echo e($settings->currency); ?>)</h5> 
                                           <input class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" value="<?php echo e($plan->gift); ?>" placeholder="Enter Additional Gift Bonus" type="text" name="gift" value="0" required>  
                                           <small class="text-<?php echo e($text); ?>">Optional Bonus if a user buys this plan. </small>  
                                       </div>
                                       <div class="form-group col-md-6">
                                       ...
                                       <div class="form-group col-md-6">
                                           ...
                                           <input class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" value="<?php echo e($plan->increment_amount); ?>" placeholder="top up amount" type="text" name="t_amount" required> 
                                       ...
                                       <div class="form-group col-md-6">
                                           ...
                                           <input class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>"value="<?php echo e($plan->expiration); ?>" placeholder="eg 1 Days, 2 Weeks, 1 Months" type="text" name="expiration" required> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Production\24fxtrade\Account\resources\views/admin/Plans/editplan.blade.php ENDPATH**/ ?>