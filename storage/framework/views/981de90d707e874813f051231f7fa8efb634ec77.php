...
<?php $__env->startSection('content'); ?>
          ...
          <div class="row">
            <div class="col-md">
              <div class="card shadow h-100">
                <img class="card-img-top" src="<?php echo e(asset('temp/images/gold-bars.jpg')); ?>" alt="Card image">
                <div class="card-body">                  
                  ...
                  <a href="<?php echo e(url('/login')); ?>" class="btn btn-outline-danger w-100">Get Started</a>
                </div>
              </div>
            </div>
            <div class="col-md">
      ...
      <section class="py-5 text-center">
        <div class="container">
          <p class="pb-3 h5">Join dynamic<span class="text-danger"> 24bitfx</span></p>
          <p class="pb-5">Licensed and regulated across multiple jurisdictions, we serve clients in over 150 countries worldwide.</p>
          <img src="<?php echo e(asset('temp/images/98114653-grey-map.png')); ?>" alt="" class="img-fluid">
        </div>
      </section>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects-work\bitfxg-laravel\resources\views/home/gold.blade.php ENDPATH**/ ?>