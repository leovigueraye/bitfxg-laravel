...
<html lang="en" data-bs-theme="auto">
  <head><script src="<?php echo e(asset('dash/js/color-modes.js')); ?> "></script>
...
.callback-popup h3 {
    ...
    <!-- Custom styles for this template -->
    <link rel="stylesheet" href="<?php echo e(asset('dash/css/dashboard.css')); ?>">
  </head>
  <body>
  ...
  <script>
    ...
    <script src="https://cdn.jsdelivr.net/npm/chart.js@4.2.1/dist/chart.umd.min.js" integrity="sha384-gdQErvCNWvHQZj6XZM0dNsAoY4v+j5P1XDpNkcM3HJG1Yx04ecqIHk7+4VBOCHOG" crossorigin="anonymous"></script><script src="<?php echo e(asset('dash/js/dashboard.js')); ?> "></script>
    <script src="<?php echo e(asset('dash/js/core/bootstrap.bundle.js')); ?> "></script>
        <!--   Core JS Files   -->
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
        <!--  -->
...
</html><?php /**PATH C:\xampp\htdocs\projects-work\bitfxg-laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>