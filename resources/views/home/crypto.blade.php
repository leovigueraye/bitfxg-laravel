...
@section('content')
            ...
            <div class="row">
                <div class="col-md text-light my-5">
                    <span class="text-center my-5">
                        <h1>Crypto</h1>
                        <p><a href="/" class="text-white">Home</a> > Crypto</p>
                    </span>
                </div>
            </div>
    </div>
    ...
    <section class="py-5">
        <div class="container">
          <div class="text-center">
            <p class="text-danger">Trade Cryptocurrencies</p>
            <h3>Gain Multiple Profits</h3>
          </div>
            <div class="row pt-2">
                <div class="col-md-5 col-sm-12">
                    <p class="pb-2">Exclusive offers allow you to trade Bitcoin, Litecoin, Ethereum in USD, EUR or RUB in other major currencies round the globe. Our support runs through the clock, and our mentor program gives you an edge on start.</p> 
                    <p class="h3 text-center py-3">The Journey of Bitcoin</p>
                ...
                <div class="col-md-7 col-md-offset-0 col-sm-10 col-sm-offset-1">
                    <div class="text-center">
                        <img src="{{ asset('temp/images/aleksi-raisa-y-BIhyjjHv4-unsplash-1024x637.jpg')}}" alt="Rounded Image" class="img-fluid">
                    </div>
                </div>
            </div>
    </div>
    ...
    <section class="py-5">
      <div class="container">
        <div class="text-center">
          <h4>Why Trade Bitcoin with bitfxg</h4>
          <p class="py-2">At bitfxg you can trade Bitcoin as a CFD. Here is why you should trade Bitcoin with us:</p>
        </div>
        <div class="row">
          <div class="col-md">
            <p>Top Level Security</p>          
            <p>Leverage We offer a leverage of up to 20:1</p>
            <p>Faster Transactions Open and close Bitcoin trades in an instant.</p>
            <p>Multiple Pairs Trade Bitcoin vs. various fiat currencies</p>
            <p>Withdrawals at any moment straight to your Wallet or Account</p>
          </div>
          <div class="col-md">
            <div class="bg-dark py-3 px-3 text-white">
              <div class="input-group mt-3 mb-3 w-75">
                <select>
                  ...
                  <option value="tether" data-val="0.9995370000">
                    USDT</option>
                <input type="text" class="form-control bg-dark" placeholder="1">
              </div>
              ...
              <select>
                ...
                <input type="text" class="form-control bg-dark" placeholder="29,780.98">
              </div>
            </div>
          </div>
        </div>
