        ...
        <div id="demo" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active ">              
                <img src="{{ asset('temp/images/shubham-dhage-_rZnChsIFuQ-unsplash.jpg')}}" alt="" class="d-block w-100 h-75 img-fluid">
              ...
              <div class="carousel-item">
                <img src="{{ asset('temp/images/shubham-dhage-208asI7iZiU-unsplash.jpg')}}" alt="" class="d-block w-100 h-75 img-fluid">
                <div class="carousel-caption">
                    <p class="display-2"> Bismit Trade</p>
                    <p class="display-2">Experienced Brokers</p>
                    <p class="text-lead">Trade the Market with experts brokers</p>
              ...
              <div class="carousel-item">
                <img src="{{ asset('temp/images/choong-deng-xiang-EbbqeyHpbto-unsplash.jpg')}}" alt="" class="d-block w-100 h-75 img-fluid">
                <div class="carousel-caption">
                    <p class="display-2"> Bismit Trade</p>
                    <p class="display-2">Experienced Brokers</p>
                    <p class="text-lead">Trade the Market with experts brokers</p>
            ...
            <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
              <div class="col d-flex align-items-start bg-light text-dark py-4">
                <div class="icon-square text-body-emphasis bg-body-secondary d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3 py-3">
                  <img src="{{ asset('temp/images/pf-icon3.png')}}" alt="" class="img-fluid">
                </div>
                <div>
              ...
              <div class="col d-flex align-items-start bg-danger text-light py-4">
                <div class="icon-square text-body-emphasis bg-body-secondary d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3 py-3">
                  <img src="{{ asset('temp/images/icon-white-stats3.png ')}}" alt="" class="img-fluid">
                </div>
                <div>
              ...
              <div class="col d-flex align-items-start bg-dark text-light py-4">
                <div class="icon-square text-body-emphasis bg-body-secondary d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3 py-3">
                  <img src="{{ asset('temp/images/icon-process3.png ')}}" alt="" class="img-fluid">
                </div>
                <div>
                    ...
                    <div class="row">
                        <div class="col-md-7 col-md-offset-0 col-sm-10 col-sm-offset-1">
                            <div class="text-center">
                                <img src="{{ asset('temp/images/viktor-forgacs-3PyBkxgTiL0-unsplash.jpg ')}}" alt="Rounded Image" class="img-rounded img-responsive img-dog img-fluid">
                            </div>
                        </div>
                        <div class="col-md-5 col-sm-12">
                            <p class="text-danger pb-2">About bitfxg </p> 
                            ...
                            <p class="h3 py-4">Why Choose bitfxg?</p>
      ...
      <div class="row row-cols-1 row-cols-md-2 g-4">
        <div class="col">
          <div class="card h-100">
            <div class="row g-0 h-100">
              <div class="col-md-6">
                <img src="{{ asset('temp/images/blockchain-technology-smart-bitcoin.jpg ')}}" alt="" class="img-fluid h-100 w-100">
              </div>
              <div class="col-md-6 bg-danger d-flex align-items-center">
                <div class="card-body">                 
                  ...
                  <a href="{{url('/crypto')}}"><button type="button" class="btn">Read More</button></a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col">
          <div class="card h-100">
            <div class="row g-0 h-100">
              <div class="col-md-6">
                <img src="{{ asset('temp/images/crude-oil.jpg')}}" alt="" class="img-fluid h-100 w-100">
              </div>
        ...
        <div class="col">
          <div class="card h-100">
            <div class="row g-0 h-100">
              <div class="col-md-6">
                <img src="{{ asset('temp/images/shutterstock_112336277-825x510-1.jpg')}}" alt="" class="img-fluid h-100 w-100">
              </div>
              <div class="col-md-6 bg-dark text-white d-flex align-items-center">
                <div class="card-body">
                  ...
                  <a href="{{url('/gold')}}"><button type="button" class="btn text-white">Read More</button></a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col">
          <div class="card h-100">
            <div class="row g-0 h-100">
              <div class="col-md-6">
                <img src="{{ asset('temp/images/forex.png ')}}" alt="" class="img-fluid h-100 w-100">
              </div>
              <div class="col-md-6 bg-danger d-flex align-items-center">
                <div class="card-body">
      ...
      <div class="conatiner-fluid bg-dark text-white px-5">
        ...
        <div class="container py-1">
            <div class="row">
                ...
                <div class="col-md-7 col-md-offset-0 col-sm-10 col-sm-offset-1">
                    <img src="{{ asset('temp/images/forex.png')}}" alt="Rounded Image" class="img-fluid ">
            </div>
            </div>
    </div>
    </section>
    ...
    <section>
      ...
      <div class="container-fluid py-2 bg-dark">
        <div class="row py-2">
          ...
          <div class="col">
            <img src="{{ asset('temp/images/devices_dpr_1.0-768x460.webp')}}" alt="" class="img-fluid">
          </div>
        </div>
          ...
          <div class="col-md">
            <div class="card">
              <div class="card-body text-center">
                <p class="card-text">I became an investor with bitfxg and the result was good. I had a mentor that followed me up, and made trading so easy.</p>               
                  <img src="{{ asset('temp/images/testimonial2-90x90.jpg')}}" alt="" class="img-thumbnail rounded-circle">
                  <h6>Sarah Reuben</h6>
            ...
            <div class="card">
              <div class="card-body text-center">
                <p class="card-text">I have consulted for several firms, and I can tell you that the guys at Bitsmit are among the best in the industry.</p>               
                  <img src="{{ asset('temp/images/testimonial1-90x90.jpg')}}" alt="" class="img-thumbnail rounded-circle">
            ...
            <div class="card">
              <div class="card-body text-center">
                <p class="card-text">One thing most people failed to realize is that you can make money everyday while sitting at the comfort of your home. This is what I do for a living.</p>               
                  <img src="{{ asset('temp/images/testimonial4-90x90.jpg')}}" alt="" class="img-thumbnail rounded-circle">
                  <h6>Lucy Brenda</h6>
                  <p>Forex Trader</p>           
            </div>
          </div>
    ...
    <section>
      <div class="container-fluid pt-5 bg-dark">
        ...
        <div class="text-center text-white pt-5 pb-2">
          <a href="{{url('/login')}}"> <button type="button" class="btn btn-danger">Open an Account</button> </a>
        </div>
      </div>
    </section>    
