...
<section>
  <div class="container">
    ...
    <div>
      <img src="{{ asset('temp/images/what-is-forex_final.png')}}" alt="" class="img-fluid">
    </div>
  </div>
...
<section>
  <div class="container py-5">
    <h4 class="text-center">Why Trade Forex with bitfxg</h4>
    ...
    <div>
      <img src="{{ asset('temp/images/about-us-hero-1024x305.webp')}}" alt="" class="img-fluid">
    </div>
  </div>
</section>
