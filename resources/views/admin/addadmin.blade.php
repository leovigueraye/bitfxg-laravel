                ...
                <div class="mb-5 row">
                    <div class="col-lg-8 offset-lg-2 card p-3 bg-{{Auth('admin')->User()->dashboard_style}} shadow">
                        <form method="POST" action="{{ url('admin/dashboard/saveadmin') }}">
                            ...
                            <div class="pt-3 form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="pt-3 form-group{{ $errors->has('l_name') ? ' has-error' : '' }}">
                            ...
                            <div class="pt-3 form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="pt-3 form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
