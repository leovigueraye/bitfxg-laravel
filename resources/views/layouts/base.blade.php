...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('temp/bootstrap/css/bootstrap.css')}}">
    <link rel="stylesheet" href="{{ asset('temp/css/style.css')}}">
    <script src="{{ asset('temp/Js/bootstrap.bundle.js')}}"></script>
    ...
    <nav class="navbar navbar-expand-lg bg-secondary navbar-dark shadow px-lg-5">
        <div class="container-fluid py-lg-3 ">
          ...
          <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="{{url('/')}}"> <strong class="pr-5">HOME</strong></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="{{url('/about')}}"> <strong class="pr-5">ABOUT US</strong></a>
              </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle px-4" href="#" role="button" data-bs-toggle="dropdown">INSTRUMENTS</a>
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{url('/crypto')}}">Crypto</a></li>
                    <li><hr class="dropdown-divider"></hr></li>
                    <li><a class="dropdown-item" href="{{url('/forex')}}">Forex</a></li>
                    <li><hr class="dropdown-divider"></hr></li>
                    <li><a class="dropdown-item" href="{{url('/gold')}}">Gold</a></li>
                </ul>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="{{url('/statistic')}}"> <strong>STATISTIC</strong></a>
              </li>
              <li class="nav-item dropdown">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{url('/contact')}}"> <strong>CONTACT US</strong></a>
              </li>
            </ul>
          ...
          <div class="">
              <form class="text-right">
                 ...
                 <a href="{{url('/login')}}"><button type="button" class="btn btn-danger px-2 py-2">Create an Account</button></a> </li>      
                </form>
          </div>
